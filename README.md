...
- 18 reference hexa-lang algorithms (`algorithms/`) — v1 catalog + `tape_render_identity` / `tape_to_md_log` / `tape_meta_verify` / `tape_domain_status` / `tape_to_md` (P1 whole-tape projection) / `md_to_tape` (P2 one-shot migration)
